    ...
    public class DriverSetup
    {
        ...
        public static IWebDriver LocalBrowserSetup(IWebDriver driver)
        {
            ...
            if (BrowserType.Chrome.ToString().Equals(browser_name))
            {
                ...
                //string extensionPath = @"C:\Users\hp\Downloads\TrustApp 1.1.17.0.crx";

                // Create an instance of ChromeOptions to set browser options
                ChromeOptions options = new ChromeOptions();
                //options.AddAdditionalChromeOption("debuggerAddress", "localhost:9988");
                ...
                // Create an instance of ChromeDriver and pass ChromeOptions
